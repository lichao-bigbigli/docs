...
export default defineConfig({
  ...
  head: [
    ['link', { rel: 'icon', type: 'image/png', href: 'theme/img/image.png' }]
  ],
  ...
  themeConfig: {
      ...
      '/48-lessons/': [
        {
          ...
          collapsed: false,
          items: [
            { text: '购买实体书', link: '/48-lessons/index' },
    ...
    socialLinks: [
      ...
      { icon: 'ri:bilibili-fill', link: 'https://space.bilibili.com/29089660?spm_id_from=333.1007.0.0' }
    ],
